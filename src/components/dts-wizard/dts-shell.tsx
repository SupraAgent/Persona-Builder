...
import { EMPTY_DTS_DRAFT, type DesignToShipDraft } from "@/lib/design-to-ship";
...
export function DtsShell() {
  ...
  const [draft, setDraft] = React.useState<DesignToShipDraft>(EMPTY_DTS_DRAFT);
